...
#define NAV_CAPS LT(NAV, KC_CAPS)
...
[MAC_BASE] = LAYOUT_tkl_ansi(
     ...
     NAV_CAPS, KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,
...
/* NAV layer — activated by holding Caps Lock (NAV_CAPS)
 *
 * Vim-style arrows:      H=Left  J=Down  K=Up  L=Right
 * Word jumping:          W=Ctrl+Right  B=Ctrl+Left
 * Line nav:              A=Home  E=End  (mnemonic: beginning/end)
 * Delete:                D=Forward-delete  Backspace=Backspace (passthrough)
 * Page nav:              U=Page Up  N=Page Down  (like Vim Ctrl-U/Ctrl-D)
 * Undo/Redo:             Z=Cmd/Ctrl+Z  Y=Cmd/Ctrl+Shift+Z
 * Select all:            ; -> Cmd/Ctrl+A
 */
[NAV] = LAYOUT_tkl_ansi(
     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,
     KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
     KC_TRNS,  KC_TRNS,  C(KC_RGHT),KC_END,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_PGUP,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
     KC_TRNS,  KC_HOME,  KC_TRNS,  KC_DEL,   KC_TRNS,  KC_TRNS,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_TRNS,  KC_TRNS,            KC_TRNS,
     KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  C(KC_LEFT),KC_PGDN, KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,            KC_TRNS,
     KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,                                KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS)
